...
::: {style="text-align: center;font-size: 60px; margin-bottom: 30px;"}
**ENVSOCTY 4GA3**
...
<div style="text-align: center;">
  ...
  <br>
  PhD Candidate in Geography at SEES
</div>
...
- Just as running 1000 metres affects individuals differently, running code on different computers or with different package versions can produce varied results.
...
- GitHub is like a cloud drive (similar to OneDrive or Dropbox) but specialised for storing code (more specifically plain text files), including R scripts.
:::
...
::: {.column width="50%"}
![](../../../2026-Winter/slides/1-intro/images/md_syntax.png){height=500px}
:::
...
- For basic Markdown syntax refer to: [www.markdownguide.org/basic-syntax](https://www.markdownguide.org/basic-syntax/)
- Markdown cheat sheet: [www.markdownguide.org/cheat-sheet](https://www.markdownguide.org/cheat-sheet/)
</div>
:::
::::
...
## Download R version 4.6.1

We will be using the **latest version** of R for this course. All course materials and code examples were tested exclusively on this specific R release.

[mirror.csclub.uwaterloo.ca/CRAN](https://mirror.csclub.uwaterloo.ca/CRAN/)
![](../../../2025-Winter/slides/1-intro/images/download_r.png){height=350px}
...
- Note: If you are using macOS or Linux, `Rtools` is **not** required.

## Windows 11 users: turn off Smart App Control (Optional)

![](../../../2026-Winter/slides/1-intro/images/app_control.png){height=300px}

Settings > Privacy & security > Windows Security > App & browser control > Smart App Control settings > Off

## Xcode and GNU Fortran for macOS users
...
## Homebrew and GDAL for macOS users
...
::: {.column width="60%"}
![](../../../2026-Winter/slides/1-intro/images/restore.png){width=300px}
![](../../../2026-Winter/slides/1-intro/images/restore1.png){width=300px}
:::

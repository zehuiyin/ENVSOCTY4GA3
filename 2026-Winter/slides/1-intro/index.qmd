...
![](./images/old_r.png){height=300px}

:::{style="font-size: 30px;"}
Windows systems: [mirror.csclub.uwaterloo.ca/CRAN/bin/windows/base/old](https://mirror.csclub.uwaterloo.ca/CRAN/bin/windows/base/old/)

Mac systems:

  - Apple silicon (ARM): [mirror.csclub.uwaterloo.ca/CRAN/bin/macosx/big-sur-arm64/base](https://mirror.csclub.uwaterloo.ca/CRAN/bin/macosx/big-sur-arm64/base/)
  - Intel based: [mirror.csclub.uwaterloo.ca/CRAN/bin/macosx/big-sur-x86_64/base](https://mirror.csclub.uwaterloo.ca/CRAN/bin/macosx/big-sur-x86_64/base/)
:::
...
## Windows 11 users: turn off smart app control

![](./images/app_control.png){height=300px}
